...
func init() {
	...
	rootCmd.AddCommand(str2asciiCmd, ascii2strCmd)
	rootCmd.AddCommand(hex2strCmd, str2hexCmd)
	rootCmd.AddCommand(hex2decCmd, dec2hexCmd, hex2bytesCmd)
	rootCmd.AddCommand(bytes2hexCmd, bytes2strCmd)
	rootCmd.AddCommand(urlencodeCmd, urldecodeCmd)
